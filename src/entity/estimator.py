...
class MyModel:
    ...
    def predict(self, dataframe:pd.DataFrame) -> DataFrame :
        ...
        applies scalling using preprocessing_object, and perform prediction on transformed features.
        """
        try:
            logging.info("Starting prediction process. ")

            # Step 1: apply scalling transformations using the pre-trained preprocessing object
