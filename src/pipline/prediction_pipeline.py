...
class Vehicle:
    ...
    def get_vehicle_input_data_frame(self) -> DataFrame :
        """
        This function returns a DataFrame from Vehicle data class input
        """
        try:
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """        
        logging.info("Entered get_vehicle_data_as_dict method of Vehicle class")
        try:
            input_data = {
                 "Gender": [self.Gender],
                "Age": [self.Age],
            ...
            logging.info("Exited get_vehicle_data_as_dict method of Vehicle class.")
            return input_data
