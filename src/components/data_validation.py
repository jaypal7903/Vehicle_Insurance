...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool :
        ...
        Description : This method is validate the number of columns
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            if not status:
                ...
                logging.info(f"All categorical/int columns are present in training dataframe: {status}")

            status = self.is_column_exist(df=test_df)
            if not status :
                validation_error_message += f"Columns are missing in test dataframe. "
            else:
                logging.info(f"All categorical/int columns are present in test dataframe: {status}")
