...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[proj1Estimator] :
        ...
        Description : This method is used to get the model from production stage.
    ...
    def _create_dummy_columns(self,df) :
        ...
        """
        logging.info("Createing dummy variables for categorical features.")
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        Description : This function is used to evaluate trained model
                      with production model and choose bast model.

        Output      : Returns bool value based on validation result
        On Failure  : Write and exception log and raise and exception
        """
        try:
            ...
            if best_model is not None :
                logging.info("Computing f1 score for prodcution model..")
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact :
        """
        Method Name : initate_model_evaluation
        Description : This function is initate the all steps of the model evaluation 
        ...
        try :
            ...
            model_evaluation_artifact = ModelEvaluationArtifact(
                is_model_accespted= evaluate_model_response.is_model_accepted,
                s3_model_path=s3_model_path,
                trained_model_path= self.model_trainer_artifact.trained_model_file_path,
                changed_accuaracy=evaluate_model_response.difference
            )
