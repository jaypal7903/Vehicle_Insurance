...
from src.pipline.prediction_pipeline import Vehicle, VehicleDataClassifier
...
# Mount a 'static' directory for serving static files like CSS
app.mount(
    "/static",
...
async def predictRouteClient(request: Request):
    """
    Retrieve form data, process it and make prediction.
    """
    ...
    try:
        ...
        # Render HTML page with prediction result
        return templates.TemplateResponse(
            request=request,
            name="vehicledata.html",
            context={
